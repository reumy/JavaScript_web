...
- [JSON](http://www.json.org/json-ko.html) 참고
...
![결과](images/jsw.31.png)

> infoobj가 객체로 변경되어 프로그래밍적으로 제어가 가능해짐

![결과](images/jsw.32.png)

> for문을 통해 값을 하나하나씩 열거

![결과](images/jsw.33.png)
...
?>
```
- `json_encode : PHP의 데이터를 JSON 형식으로 전환해주는 PHP의 내장함수`
- `json_decode : PHP의 데이터를 원래 상태로 전환해주는 PHP의 내장함수`
